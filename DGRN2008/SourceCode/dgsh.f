...
c     work space
c
      integer i,istp,l,n,lup,llw,key
      double precision b(2,4)
      double precision yup(2),ylw(2),yup0(2),ylw0(2),coef(2,2)
c
c===============================================================================
c
...
c
      ...
      enddo
      key=0
      call gemp(coef,b,2,4,0.d0,key)
      if(key.eq.0)then
        print *,'warning in dgsh: anormal exit from gemp!'
        return
      endif
      if(lzrec.lt.ls)then
        do istp=1,4
