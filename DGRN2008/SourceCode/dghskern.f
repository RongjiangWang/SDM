...
c
      double precision k
      double precision lahs,muhs,yhs(8,4)
c
      include 'dgglob.h'
c
c     work space
c
      ...
      double precision h0
      double precision wave,wave2,cdet
      double precision b(6,4),orth(3,3)
      double precision yup(6,3),ylw(6,3),y1(6,3)
      double precision c0(6,3),c1(6,3),yup0(6,3),ylw0(6,3)
      double precision mat(6,6),mai(6,6),coef(6,6)
c
...
c
        ...
        c1(6,3)=c1(6,3)*wave2
c
        call hsmatrix(mat,k,h0,lahs,muhs)
