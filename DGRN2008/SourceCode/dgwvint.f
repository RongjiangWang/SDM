...
c
      integer i,istp,ir
      integer ik,nk,nx,nr0
      double precision x,k,k0,dk,dk0,dkmax
      double precision wl,wr,zdis,udif,uabs,fac
      double precision umax(4),r0(nrmax),usum
      double precision lahs,muhs
      double precision cics(4),cms(4),cbs(3),uk(3)
      double precision y(8,4),cy0(3,4)
      double precision u0(nrmax,3,4)
      logical again
c
      integer iret
      double precision xokada,yokada,dip
      double precision alpha,pot1,pot2,pot3,pot4,cs45,ss45
      double precision ux,uy,uz,uxx,uyx,uzx,uxy,uyy,uzy,uxz,uyz,uzz
      double precision uza,ura,uta
c
      integer nkmin,nkmax
