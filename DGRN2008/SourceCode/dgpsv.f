...
c
      double precision k
      double precision y(8,4)
c
      include 'dgglob.h'
c
c     work space
c
      integer i,istp,j,l,n,lup,llw,key
      double precision b(6,4),cy(6,4)
      double precision yup(6,3),ylw(6,3)
      double precision ma0(6,6),c0(6,3),coef(6,6)
      double precision yup0(6,3),ylw0(6,3)
c
c===============================================================================
c
      lup=1
...
c
      ...
      if(key.eq.0)then
        print *,'warning in dgpsv: anormal exit from gemp!'
        return
      endif
      if(lzrec.lt.ls)then
        do istp=1,4
