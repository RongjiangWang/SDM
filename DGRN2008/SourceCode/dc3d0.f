     ...
     *               ux,uy,uz,uxx,uyx,uzx,uxy,uyy,uzy,uxz,uyz,uzz,iret)
      ...
      double precision pot1,pot2,pot3,pot4,alpha,ux,uy,uz
      double precision uxx,uyx,uzx,uxy,uyy,uzy,uxz,uyz,uzz
c
c********************************************************************
c*****                                                          *****
...
c
      ...
      double precision xx,yy,zz,dd,pp1,pp2,pp3,pp4,du
      double precision aalpha
      double precision u(12),dua(12),dub(12),duc(12)
c
      double precision dummy(8),r,dumm(15)
...
c===============================================================================
      ...
      implicit none
      double precision x,y,d,pp1,pp2,pp3,pp4
      double precision u(12)
c
c********************************************************************
...
c
      integer i
      double precision du(12)
c
      double precision alp1,alp2,alp3,alp4,alp5
      double precision sd,cd,sdsd,cdcd,sdcd,s2d,c2d
      common /c0/alp1,alp2,alp3,alp4,alp5,sd,cd,sdsd,cdcd,sdcd,s2d,c2d
c
      double precision p,q,s,t,xy,x2,y2,d2,r,r2,r3,r5,qr,qrx,a3,a5,b3,c3
      double precision uy,vy,wy,uz,vz,wz
      common /c1/p,q,s,t,xy,x2,y2,d2,r,r2,r3,r5,qr,qrx,a3,a5,b3,c3,
     *           uy,vy,wy,uz,vz,wz
c
      double precision f0,f1,f3
...
c===============================================================================
      ...
      implicit none
      double precision x,y,d,z,pp1,pp2,pp3,pp4
      double precision u(12)
c
c********************************************************************
...
c
      integer i
      double precision c,rd,d12,d32,d33,d53,d54,fi1,fi2,fi3,fi4,fi5
      double precision fj1,fj2,fj3,fj4,fk1,fk2,fk3
      double precision du(12)
c
      double precision alp1,alp2,alp3,alp4,alp5
      double precision sd,cd,sdsd,cdcd,sdcd,s2d,c2d
...
c
     ...
     *           uy,vy,wy,uz,vz,wz
c
      double precision f0,f1,f2,f3,f4,f5,f8,f9
...
c
      integer i
      double precision c,q2,r7,a7,b5,b7,d7,c5,c7,qr5,qr7,dr5
      double precision du(12)
c
      double precision alp1,alp2,alp3,alp4,alp5
      double precision sd,cd,sdsd,cdcd,sdcd,s2d,c2d
      common /c0/alp1,alp2,alp3,alp4,alp5,sd,cd,sdsd,cdcd,sdcd,s2d,c2d
c
      double precision p,q,s,t,xy,x2,y2,d2,r,r2,r3,r5
      double precision qr,qrx,a3,a5,b3,c3,um(6)
      common /c1/p,q,s,t,xy,x2,y2,d2,r,r2,r3,r5,qr,qrx,a3,a5,b3,c3,um
c
      double precision f0,f1,f2,f3,f5,f7,f10,f15
      data f0,f1,f2,f3,f5,f7,f10,f15
     *        /0.d0,1.d0,2.d0,3.d0,
     *         5.d0,7.d0,10.d0,15.d0/
c
      double precision pi2
      data pi2/6.283185307179586d0/
c
...
c
      double precision r7
c
      double precision dummy(5),sd,cd,dumm(5)
...
c
      ...
      double precision f0,f1,f3,f5
      data eps/1.d-6/
      data f0,f1,f3,f5/0.d0,1.d0,3.d0,5.d0/
c
