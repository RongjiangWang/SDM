...
c~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      integer*4 NSMAX,NFTMAX,NPSMAX,NZSMAX,NRMAX
...
c~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      integer*4 nft(NSMAX),nlength(NSMAX),nwidth(NSMAX)
      integer*4 nps1(NSMAX),nps2(NSMAX)
      real*8 topdep(NSMAX),width(NSMAX)
      real*8 mstrike(NSMAX),patchsize(NSMAX)
      real*8 latft(NFTMAX,NSMAX),lonft(NFTMAX,NSMAX)
      real*8 topdip(NFTMAX,NSMAX),botdip(NFTMAX,NSMAX)
...
c~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      real*8 plat(NPSMAX),plon(NPSMAX)
      real*8 pl(NPSMAX),pw(NPSMAX),pz(NPSMAX)
